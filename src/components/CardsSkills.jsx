...
const tecnologias = {
  Frontend: [
    ...
    {
      nome: "Sass / SCSS",
      icone: <SiSass className="text-pink-400 text-5xl" />,
    },
    {
      nome: "JavaScript",
      icone: <SiJavascript className="text-yellow-400 text-5xl" />,
    },
    {
      nome: "React",
      icone: <RiReactjsLine className="text-[#41a0be] text-5xl" />,
    },
    {
      nome: "Tailwind",
      icone: <RiTailwindCssLine className="text-cyan-400 text-5xl" />,
    },
  ],
  Backend: [
    {
      nome: "Python",
      icone: <SiPython className="text-yellow-300 text-5xl" />,
    },
    ...
    {
      nome: "Node.js",
      icone: <FaNodeJs className="text-7xl mx-auto text-[#539e43]" />,
    },
  ],
  BancodeDados: [
  ...
  Mobile: [
    {
      nome: "Flutter",
      icone: <SiFlutter className="text-6xl text-[#41a0be] mb-3" />,
    },
    {
      nome: "Firebase",
      icone: <SiFirebase className="text-6xl text-[#ffcc30] mb-3" />,
    },
  ],
  Ferramentas: [
    ...
    {
      nome: "Postman",
      icone: <SiPostman className="text-7xl mx-auto text-[#ff6c37]" />,
    },
    {
      nome: "GitLab",
      icone: <FaGitlab className="text-7xl mx-auto text-[#e24329]" />,
    },
  ],
};
...
export default function CardsTecnologias() {
  ...
  return (
    <section
      id="cardSkills"
      className="min-h-screen bg-black/90 text-white text-center flex flex-col items-center justify-center scroll-mt-28"
    >
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 justify-center place-items-center">
          {tecnologias[categoriaSelecionada].map((tec, index) => (
            ...
            >
              {tec.icone}
              <p className="mt-2 text-sm font-semibold text-gray-200 text-center">
                {tec.nome}
              </p>
            </div>
          ))}
