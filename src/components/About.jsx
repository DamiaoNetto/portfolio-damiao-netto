...
export default function About() {
  return (
    <section
      id="about"
      className="min-h-screen flex items-center justify-center px-6 bg-black/90 text-white scroll-mt-20"
    >
        ...
        <div className="mx-auto w-full bg-[#31383b] rounded-2xl p-6 md:p-10 grid grid-cols-1 lg:grid-cols-2 items-center gap-10 border border-white/20">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-slate-200 mb-4 leading-relaxed">
              Sou estudante de Tecnologia em Sistemas para Internet pelo IFRN e
              aluno do curso Full Stack do Vai na Web. Apaixonado por criar
              experiências web que unem propósito, estética e performance, busco
              sempre desenvolver interfaces modernas e funcionais.{" "}
            </p>
            <p className="text-slate-200 mb-4 leading-relaxed">
              Atuo como desenvolvedor Front-end, com foco em usabilidade e boas
              práticas de desenvolvimento. Atualmente, estou iniciando minha
              jornada como freelancer, ampliando meus conhecimentos e
              aprimorando minhas habilidades a cada novo projeto.
            </p>
